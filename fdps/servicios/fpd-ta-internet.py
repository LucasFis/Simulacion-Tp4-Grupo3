...
print(llamadas_internet.value_counts())
#Grafico histograma
...
fdp_internet_ta_betaprime = stats.betaprime.rvs(a, b, loc, scale, 300)
print(fdp_internet_ta_betaprime.min(), fdp_internet_ta_betaprime.max())
